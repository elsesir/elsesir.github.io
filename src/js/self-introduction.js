    ...
    var parsonalInformation = new Vue({
        ...
        methods : {
            ...
            showYCJ: function() {
                ...
                '<div><span>主要工作：</span>1. 在PC 端相关页面添加波段收割者入口信息，包括修改Vue 弹窗组件；2. 修改PC 端自写的superK 线图组件，删除无用的弹窗页面；3. 完善PC 和M 端用户资料页逻辑；4. 为M 端添加分时复权计算、波段收割者功能模块；5. 波段分割者助力分享模块及波段收割者功能权限控制；6. 修改M 端首页交互滑动切换功能。</div><';
                this.showPop();
            },
            showEDU: function() {
